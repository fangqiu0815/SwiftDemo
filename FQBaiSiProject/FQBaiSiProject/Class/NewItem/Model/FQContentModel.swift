...
class FQContentModel: NSObject {
    ...
    init(dict: [String: Any]) {
        ...
        if let array = dict["top_cmt"] as? [[String : Any]], array.count > 0 {
            top_cmt = FQCommentModel(dict: array.first!)
        }
    ...
    var cellHeight: CGFloat {
        get {
            if _cellHeight == 0 {
                ...
                _cellHeight = kCellHeaderHeight + size.height + kCellFooterHeight + 4 * kCellTextMargin
